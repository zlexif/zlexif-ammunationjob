...
--{ options = { {  event = "zlexif-ammunation:Client:Storage", icon = "fas fa-box", label = "Stash", job = Config.Job }, },  distance = 2.0 })
    -- || ===============> Ammo
exports[Config.Target]:AddBoxZone("WeaponsCraft",vector3(22.7, -1104.32, 29.8), 0.6, 6, 
    { name="WeaponsCraft", heading = 340, debugPoly = false, minZ = 26.4, maxZ = 30.4 }, 
    { options = { {   action = function() CraftWeaponsMenu() end, icon = "fa-solid fa-gun", label = "Weapons Crafts", job = Config.Job }, },  distance = 2.0 })
...
-- || ===============> Ammo
exports[Config.Target]:AddBoxZone("AmmoCraft", vector3(17.19, -1111.4, 29.8), 0.8, 3, 
    { name="AmmoCaft", heading = 70, debugPoly = false, minZ = 26.2, maxZ = 30.2 }, 
    { options = { {   action = function() CraftAmmoMenu() end, icon = "fa-solid fa-gun", label = "Ammo Crafts", job = Config.Job }, },  distance = 2.0 })
-- || ===============> Weapons 2
